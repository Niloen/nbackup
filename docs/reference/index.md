...
nav_order: 7
has_children: true
description: "Command reference, configuration reference, and the by-hand restore procedure."
---

# Reference

Look-up material: every command, every config key, and the procedure to restore
without NBackup at all.
