...
type Header struct {
	...
	Shape     Shape     `json:"shape,omitempty"` // stream shape (see Shape) — forensic like Host/Archiver: a framed payload still decodes with the plain stock one-liner, this just says the restart points exist
