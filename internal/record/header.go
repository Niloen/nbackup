...
type Header struct {
	...
	Shape     string    `json:"shape,omitempty"` // stream shape (ShapeStream/ShapeFramed) — forensic like Host/Archiver: a framed payload still decodes with the plain stock one-liner, this just says the restart points exist
