...
//     per archive.
//   - write: a Session is an archiveio.Store — the medium end for a run. A writer authored over it
...
//     read a staged archive back and drop it. There is no seal: a run is its committed archives.
